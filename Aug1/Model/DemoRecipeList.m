...
- (void)setup
{
    ...
    // recipe 4
    r = [[Recipe alloc] init];
    r.recipeName = @"Greek Caponata";
    r.authorName = @"Giada De Laurentiis";
    r.prepTime = 10 * 60;
    r.cookTime = 55 * 60;
    r.rating = 5.0;
    ...
    r.recipeImage = [UIImage imageNamed:@"veggies.jpg"];
    r.photographer = @"n/a";
    ...
    // recipe 5
    r = [[Recipe alloc] init];
    r.recipeName = @"Mushroom and Cauliflower Lasagna";
    r.authorName = @"Bobby Flay";
    r.prepTime = 85 * 60;
    r.cookTime = 140 * 60;
    r.rating = 4.0;
    ...
    r.recipeImage = [UIImage imageNamed:@"lasagna.jpg"];
